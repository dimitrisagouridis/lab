...
```{r setup-tibble}
team_data <- tibble(
  name = c("Dimitris Agouridis", "Dimitris Bardanis", "Sam Prior", 
           "Shane Chesen"),
  github_username = c("dimitrisagouridis", "shanechesen", "DimitrisBardanis", 
                      "S-Pri0r"), 
  colour = c("blue", "lightgreen", "darkgreen", 
             "darkorange"),
  hobby = c("football", "travelling", "tennis", 
            "guitar"),
  favourite_number = c(2, 24, 34, 7,)
  )
